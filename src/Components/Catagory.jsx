...
const Catagory = () => {
    ...
    return (
        <div className='bg-white ' style={{ textAlign: 'center' }}>
            ...
            <div className='row row-cols-4'style={{paddingLeft:"250px",marginBottom:"20px",marginTop:"30px"}}>
            
                {
                   products.map(product=><div className='d-flex justify-content-between col-2 card mx-3 border-0 fs-4 fw-bold text-start' style={{background: "linear-gradient(90deg, rgba(126, 144, 254, 0.05) 0%, rgba(152, 115, 255, 0.05) 100%)"
